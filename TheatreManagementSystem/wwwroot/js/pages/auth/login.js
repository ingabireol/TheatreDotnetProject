...
<<<<<<< HEAD
// login.js - Updates to connect to the ASP.NET backend
=======
...
<<<<<<< HEAD
        ...
        apiService.auth.login({ username, password })
            .then(response => {
                ...
                // Try to extract role from token (in a real app, you'd decode the JWT)
                // For simplicity, we'll assume the response includes a role
                if (response.role) {
